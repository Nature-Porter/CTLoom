...
def build_teammate_tools(
    ...
    from ctloom.tools.send_message import SendMessageTool
    from ctloom.tools.task_create import TaskCreateTool
    from ctloom.tools.task_get import TaskGetTool
    from ctloom.tools.task_list import TaskListTool
    from ctloom.tools.task_update import TaskUpdateTool
