...
PROJECT_AGENTS_DIR = ".ctloom/agents"
USER_AGENTS_DIR = "~/.ctloom/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("ctloom.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from ctloom.agents.parser import parse_frontmatter, _validate_agent_meta
