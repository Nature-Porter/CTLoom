...
from ctloom.serialization import build_messages
...
SESSION_SUBDIR = ".ctloom/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from ctloom.tools.base import StreamEnd, StreamEvent, TextDelta
