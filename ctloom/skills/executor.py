...
from ctloom.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from ctloom.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from ctloom.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
