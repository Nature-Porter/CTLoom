...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from ctloom.agents.fork import ForkError, build_forked_messages
        from ctloom.agents.parser import AgentDef
        from ctloom.agents.tool_filter import resolve_agent_tools
        from ctloom.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from ctloom.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from ctloom.agents.fork import ForkError, build_forked_messages
        from ctloom.agents.parser import AgentDef
        from ctloom.agents.tool_filter import build_teammate_tools
        from ctloom.agent import Agent as AgentClass
        from ctloom.conversation import ConversationManager
        from ctloom.permissions import (
            DangerousCommandDetector,
        ...
        from ctloom.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from ctloom.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from ctloom.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from ctloom.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from ctloom.client import create_client
        from ctloom.config import ProviderConfig
