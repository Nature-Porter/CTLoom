...
from ctloom.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from ctloom.tools.edit_file import EditFile
    from ctloom.tools.file_state_cache import FileStateCache
    from ctloom.tools.glob import Glob
    from ctloom.tools.grep import Grep
