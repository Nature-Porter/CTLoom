...
from ctloom.teams.backend_detect import BackendDetectionError, detect_backend
from ctloom.teams.mailbox import Mailbox, create_message
...
from ctloom.teams.progress import TeammateProgress
from ctloom.teams.registry import AgentNameRegistry
from ctloom.teams.shared_task import SharedTaskStore
from ctloom.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from ctloom.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
