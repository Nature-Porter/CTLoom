...
from ctloom.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from ctloom.agent import Agent
    from ctloom.conversation import ConversationManager
    from ctloom.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from ctloom.conversation import ConversationManager as CM
                conv = CM()
