...
from ctloom.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from ctloom.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from ctloom.agents.trace import TraceManager, TraceNode
from ctloom.agents.task_manager import BackgroundTask, TaskManager
from ctloom.agents.notification import format_task_notification, inject_task_notifications
from ctloom.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".ctloom" / "agents"
...
class TestAgentToolParams:
    def test_required_fields(self):
        from ctloom.tools.agent_tool import AgentToolParams
